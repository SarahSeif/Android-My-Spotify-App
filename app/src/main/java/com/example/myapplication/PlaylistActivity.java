...
public class PlaylistActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dance.add(new Song("Lonely- This is a veryyy long text to test function","Alan Walker,Steve Aoki",R.raw.alan_walker_steve_aoki_lonely,R.drawable.lonely_alan));
